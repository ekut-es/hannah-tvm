...
IS_TEMPLATE = not os.path.exists(
    os.path.join(PROJECT_DIR, MODEL_LIBRARY_FORMAT_RELPATH)
)
...
class Handler(server.ProjectAPIHandler):
    ...
    def generate_project(
        ...
        # Populate Makefile.
        shutil.copy2(
            pathlib.Path(__file__).parent / "Makefile", project_dir / "Makefile"
        )
        ...
        os.mkdir(src_dir)
        shutil.copy2(
            os.path.join(os.path.dirname(__file__), "main.cc"),
    ...
    def _set_nonblock(self, fd):
        ...
        assert (
            new_flag & os.O_NONBLOCK
        ) != 0, "Cannot set file descriptor {fd} to non-blocking"
